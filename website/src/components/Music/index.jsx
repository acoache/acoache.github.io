    ...
    <div>
      ...
      <div className={mainStyle}>
        ...
        <div className="music_search">
          <a href="#EDM">EDM</a>
          <a href="#FolkPop">Folk / Pop</a>
          <a href="#FutureHouse">Future House</a>
          <a href="#IndieRock">Indie Rock</a>
          <a href="#Neoclassical">Neoclassical</a>
          <a href="#RBSoul">R&B / Soul</a>
          <a href="#TropicalHouse">Tropical House</a>
          <a href="#Misc">Misc</a>
          <a href="#Spotify">Spotify Playlists</a>
