    ...
    <div className="presentations" id="Presentations">
      ...
      <div className="Invited">
        <ul>
          <li>
            <p>
              <i>9th London-Paris Bachelier Workshop, London.</i> (November 6, 2025)
              Optimal Trading Across Coexisting Exchanges: LOBs and AMMs.
                [<a href={Bachelier2025}>Slides</a>]
            </p>
          </li>
        </ul>
        <ul>
          <li>
            <p>
              <i>SIAM Conference on Financial Mathematics and Engineering, Miami.</i> (July 16, 2025)
              Optimal Trading Across Coexisting Exchanges: LOBs and AMMs.
                [<a href={SIAM2025}>Slides</a>]
            </p>
          </li>
        </ul>
        <ul>
      ...
      <div className="contributed">
        <ul>
          <li>
            <p>
            <i>Advanced Mathematical Methods for Finance, Verona.</i> (Jun. 26, 2025)
              Optimal Trading Across Coexisting Exchanges: LOBs and AMMs.     [
                <a href={aMaMeF2025} target="_blank" rel="noreferrer">Slides</a>
                ]
            </p>
          </li>
        </ul>
